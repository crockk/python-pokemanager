...
class EditPokemonPopup(tk.Frame):
    ...
    def __init__(self, parent, manager_id, member_id, close_callback):
        ...
        tk.Label(self, text='Edit your Pokemon!', bg='indian red', fg='black').grid(row=1, column=1)
        ...
        tk.Label(self, text="Held Item:", bg=self._text_bg, fg='black').grid(row=3, column=1)
